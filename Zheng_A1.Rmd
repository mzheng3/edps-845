...
PISA_usa_math_44 <- read.table ("C:\Users\Zheng\Desktop\Summer 2016\EDPS 845 R\edps-845\Booklet1_44_recoded")

data1 <- read.table ("3ALIKE")

View(EDPS845data1)
View(`3ALIKE`)

inp <- scan("3ALIKE.DAT", list("",0,0))
label <- inp[[1]]; x <- inp[[2]]; y <- inp[[3]]
inp <- scan("3ALIKE.DAT", list(id="", x=0, y=0))
